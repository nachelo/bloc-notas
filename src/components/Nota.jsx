    ...
    >
      ...
      <div className="nota-header">
        {editTitulo ? (
          ...
          <h2 className="nota-titulo" onClick={() => setEditTitulo(true)}>
            {titulo || "Sin título"}
          </h2>
        )}
            ...
            <div className="color-selector" ref={selectorRef}>
              ...
              <div className="color-custom-input">
                <input
                  ...
                  onChange={(e) => setHexPersonalizado(e.target.value)}
                  onKeyDown={(e) => {
                    e.stopPropagation();
                    if (e.key === "Enter") {
                      if (/^#[0-9A-Fa-f]{6}$/.test(hexPersonalizado)) {
      ...
      <div className="nota-fechas">
        <div>
          <div className="nota-fecha">{mostrarFechaBonita(fechaCreacion)}</div>
